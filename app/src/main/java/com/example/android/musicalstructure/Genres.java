...
public class Genres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPlayerPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!playerSongTitle.getText().equals(getText(R.string.select_a_song))) {
                    ...
                    Toast toast = Toast.makeText(Genres.this, R.string.toast_choose_song,Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        });
        ...
        /*
          Create an {@link android.widget.ArrayAdapter}, whose data source is a list of genres.
          The adapter knows how to create layouts for each item in the list, using the
          genre_item.xml layout resource. This list item layout contains a Relative Layout
          {@link android.widget.RelativeLayout}, which contains a TextView and an ImageView
          the adapter will set to display states of the genre object.
         */
        ArrayList genres = db.getGenres();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for(int i = 0; i < db.getAlbums().size(); i++) {
                    ...
                    String clickedGenreName = db.getGenres().get(position).getGenreName();
                ...
                Intent openAlbums = new Intent(Genres.this, Albums.class);
                openAlbums.putExtra("clickedGenreName", db.getGenres().get(position).getGenreName());
        ...
        setTitle(getString(R.string.all_genres));
    }
